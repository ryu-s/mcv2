...
using YtTools = YouTubeLiveSitePlugin.Tools;
...
namespace YouTubeLiveSitePluginTests
{
    ...
    class ToolsTests
    {
        ...
        public void ExtractYtInitialFromSubscribedChannelHtmlTest()
        {
            ...
            var s = YtTools.ExtractYtInitialDataFromChannelHtml(data);
        ...
        public void YtInitialDataNotContainsContentsTest()
        {
            ...
            Assert.Throws<YouTubeLiveSitePlugin.YouTubeLiveServerErrorException>(() => YouTubeLiveSitePlugin.Tools.ParseYtInitialData(data));
        }
        [Test]
        ...
        public void ParseGetLiveChat_ReloadContinuationTest()
        {
            ...
            var (c, d, t) = YtTools.ParseGetLiveChat(data);
        ...
        public void ExtractYtPlayerConfigTest()
        {
            ...
            var ytPlayerConfig = YtTools.ExtractYtPlayerConfig(data);
        ...
        public void ExtractLiveBroadcastDetailsTest()
        {
            ...
            var liveBroadcastDetails = YtTools.ExtractLiveBroadcastDetails(data);
        ...
        public void Test1()
        {
            ...
            var liveBroadcastDetails = YtTools.ExtractLiveBroadcastDetailsFromLivePage(data);
            Assert.IsTrue(!string.IsNullOrEmpty(liveBroadcastDetails));
        }
        [Test]
        public void Test2()
