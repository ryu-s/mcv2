...
{
    internal class MildomSiteOptions : DynamicOptionsBase, IMildomSiteOptions
    {
        /// <summary>
        /// @コテハンを自動登録するか
        /// </summary>
        ...
        internal MildomSiteOptions Clone()
        {
            return (MildomSiteOptions)this.MemberwiseClone();
        }
        internal void Set(MildomSiteOptions changedOptions)
        {
        ...
        public void Set(IMildomSiteOptions t)
        {
            if (t is MildomSiteOptions other)
            {
                this.Set(other);
            }
        }
