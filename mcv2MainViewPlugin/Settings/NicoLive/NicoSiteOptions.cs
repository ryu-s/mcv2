...
{
    class NicoSiteOptionsCopy : OptionsCopyBase<INicoSiteOptions>, INicoSiteOptions
    {
        public int OfficialRoomsRetrieveCount { get; set; }
        public int ResNum { get; set; }
        public Color OperatorBackColor { get; set; }
        public Color OperatorForeColor { get; set; }
        public Color AdBackColor { get; set; }
        public Color AdForeColor { get; set; }
        public Color ItemBackColor { get; set; }
        public Color ItemForeColor { get; set; }
        public bool IsShow184 { get; set; }
        public bool IsAutoSetNickname { get; set; }
        public bool IsShow184Id { get; set; }
        public bool IsAutoGetUsername { get; set; }
    ...
    internal class NicoSiteOptions : DynamicOptionsBase, INicoSiteOptions
    {
        ...
        public void Set(INicoSiteOptions t)
        {
            if (t is NicoSiteOptions other)
            {
                this.Set(other);
            }
        }
