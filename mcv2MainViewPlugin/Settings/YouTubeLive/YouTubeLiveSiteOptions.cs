...
namespace mcv2.MainViewPlugin
{
    internal class YouTubeLiveSiteOptions : DynamicOptionsBase, IYouTubeLiveSiteOptions
    {
        ...
        internal void Set(IYouTubeLiveSiteOptions changedOptions)
        {
            var props = typeof(IYouTubeLiveSiteOptions).GetProperties(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
