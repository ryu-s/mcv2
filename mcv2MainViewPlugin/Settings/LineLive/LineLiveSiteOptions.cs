...
{
    internal class LineLiveSiteOptions : DynamicOptionsBase, ILineLiveSiteOptions
    {
        ...
        internal LineLiveSiteOptions Clone()
        {
            return DeepClone(this);
        }
        internal void Set(LineLiveSiteOptions changedOptions)
        {
