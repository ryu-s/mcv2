...
{
    class OpenrecSiteOptionsCopy : OptionsCopyBase<IOpenrecSiteOptions>, IOpenrecSiteOptions
    {
        public int StampSize { get; set; }
        public bool IsPlayStampMusic { get; set; }
        public string StampMusicFilePath { get; set; }
        public bool IsPlayYellMusic { get; set; }
        public string YellMusicFilePath { get; set; }
    ...
    internal class OpenrecSiteOptions : DynamicOptionsBase, IOpenrecSiteOptions
    {
        ...
        public void Set(IOpenrecSiteOptions t)
        {
            if (t is OpenrecSiteOptions other)
            {
                this.Set(other);
            }
        }
