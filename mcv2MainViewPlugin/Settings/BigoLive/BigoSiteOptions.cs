...
namespace mcv2.MainViewPlugin
{
    internal class BigoSiteOptions : DynamicOptionsBase, IBigoSiteOptions
    {
        ...
        {
            return (BigoSiteOptions)this.MemberwiseClone();
        }
        internal void Set(BigoSiteOptions changedOptions)
        {
        ...
        public void Set(IBigoSiteOptions t)
        {
            if (t is BigoSiteOptions other)
            {
                this.Set(other);
            }
        }
