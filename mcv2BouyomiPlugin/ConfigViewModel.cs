...
namespace mcv2BouyomiPlugin
{
    class ConfigViewModel : ViewModelBase
    {
        ...
        {
            get { return _options.HostAddr; }
            set { _options.HostAddr = value; }
        }
        public int HostPort
        {
            get { return _options.HostPort; }
            set { _options.HostPort = value; }
        }
        ...
        {
            get { return _options.VoiceTypeSelectedIndex; }
            set { _options.VoiceTypeSelectedIndex = value; }
        }
