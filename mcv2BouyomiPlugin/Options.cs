...
namespace mcv2BouyomiPlugin
{
    class Options : DynamicOptionsBase
    {
        ...
        public string HostAddr { get { return GetValue(); } set { SetValue(value); } }
        public int HostPort { get { return GetValue(); } set { SetValue(value); } }
        ...
        public int VoiceTypeSelectedIndex { get { return GetValue(); } set { SetValue(value); } }
        ...
        protected override void Init()
        {
            ...
            Dict.Add(nameof(HostAddr), new Item { DefaultValue = "127.0.0.1", Predicate = s => true, Serializer = s => s, Deserializer = s => s });
            Dict.Add(nameof(HostPort), new Item { DefaultValue = 50001, Predicate = n => n > 0, Serializer = n => n.ToString(), Deserializer = n => int.Parse(n) });
            ...
            Dict.Add(nameof(VoiceTypeSelectedIndex), new Item { DefaultValue = 0, Predicate = n => n >= 0, Serializer = n => n.ToString(), Deserializer = n => int.Parse(n) });
