...
namespace ColorPickerWPF
{
    ...
    public partial class ColorPickerControl : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedColorProperty =
            DependencyProperty.Register(nameof(SelectedColor), typeof(Color), typeof(ColorPickerControl), new PropertyMetadata(Colors.White));
        ...
        private void UpdateImageForHSV()
        {
            ...
            var img =
                new BitmapImage(new Uri("pack://application:,,,/Common;component/Wpf/ColorPicker/Resources/colorpicker2.png",
                    UriKind.Absolute));
