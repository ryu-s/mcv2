                ...
                case "BY_OWNER":
                    ...
                    if (comment.NgWordIncluded)
                    {
                        ...
                        message = new WhowatchNgComment(raw)
                        {
                            ...
                            PostedAt = SitePluginCommon.Utils.UnixtimeToDateTime((long)comment.PostedAt / 1000),
                ...
                case "BY_OWNER":
                    ...
                    if (comment.IsDefined("ng_word_included") && comment.ng_word_included == true)
                    {
                        ...
                        message = new WhowatchNgComment(raw)
                        {
                            ...
                            Comment = comment.message,
                            Id = comment.id.ToString(),
                            PostedAt = SitePluginCommon.Utils.UnixtimeToDateTime((long)comment.posted_at / 1000),
                            UserId = comment.user.id.ToString(),
                            UserPath = comment.user.user_path,
